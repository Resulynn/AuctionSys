    ...
    <div class="login">
        <div class="row"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 48.165 48.165">
               ...
               {!! Form::open(['action'=>'App\Http\Controllers\LoginController@store',
              'method'=>'POST']) !!}
            <div class="login-container">
                ...
                <div class="keepsigned col">
                    <input class="keepsigned" type="checkbox" value="" id="flexCheckDefault">
                    <label class="keepsigned-label" for="flexCheckDefault">
                        Keep me signed in
                    </label>
                </div>
