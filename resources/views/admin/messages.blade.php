...
@section('content')
    ...
    <div class="border mx-5 mb-5 mt-4 ">
        ...
        <div>
            ...
            'method'=>'POST']) !!} 
            {!! Form::text('message', '', ['class' => 'form-control border', 'style' => 'background:none; ; border-radius:0%; ','placeholder' => 'Enter your message here.', 'required '] )!!}
            ...
            @foreach($messages as $message)
                <div class="list-group p-3 list-group-flush border-bottom d-flex " style="border-right:1px#dddddd solid;">
                    <div class="ms-1 mb-2">
                        ...
                        <b><label for="" style="font-size: 16px;">{{$user->username}}</label></b>
