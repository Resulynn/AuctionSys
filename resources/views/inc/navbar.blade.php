...
<a class="navbar-brand" href="/home"> <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 48.165 48.165">
...
<form type="get" action="{{url ('/search')}}" class="d-flex  justify-content-center align-items-center" style="float: left;">
    <input type="search" name="search" class="search form-contro" placeholder="Search for Items">
    <button type = "submit" class="btn me-3"><i class="bi bi-search"></i></button>
</form>
</nav>
